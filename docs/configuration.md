...
| Variable | Description | Example |
|----------|-------------|---------|
| `TG_ADMIN_IDS` | Comma-separated Telegram user IDs allowed to use the bot. If not set, any user can interact with the bot. | `123456789,987654321` |
...
4. After creation, copy the `api_id` (number) and `api_hash` (string) to your `.env`
